...
* **Better Continents** is free software under the **GNU Lesser General Public License v2.1** (see [LICENSE](LICENSE)).
* Each release package also carries the notices for the third-party code built into the DLL, the exact source of that release, the updated Better Continents Guide PDF, the Export & Import guide PDF and the AI-agent skill PDF (all three GNU GPL v3).
